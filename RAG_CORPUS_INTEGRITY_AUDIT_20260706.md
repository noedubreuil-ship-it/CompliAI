...
| Findings P2 (mineur) | 5 |
| Règlements absents du corpus | 10 |
| Règlements inconnus (hors spec) | 22 |

## Findings P2 — Mineur

- **Directive NIS 2 (UE 2022/2555)** : 38 chunks enfants sans parent_chunk_id
- **Directive DSM (UE 2019/790) — droit d'auteur marché unique numérique** : 10 chunks enfants sans parent_chunk_id
- **Règlement Machines (UE 2023/1230) — produits IA intégrés** : Considérants : 86/111 (77%)
- **Règlement Machines (UE 2023/1230) — produits IA intégrés** : 103 chunks enfants sans parent_chunk_id
- **Règlement DORA (UE 2022/2554) — Résilience opérationnelle numérique du secteur financier** : Considérants : 102/118 (86%)
...
- Directive ePrivacy (UE 2002/58/CE) — communications électroniques & cookies
...
- eIDAS 2 — Identité numérique (UE 910/2014 mod. 2024/1183)
