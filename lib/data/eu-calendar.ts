...
const EVENTS: CalendarEvent[] = [
  ...
  // ══════════════════════════════════════════════════════════
  // NOUVELLES INSTITUTIONS — BCE, ECA, CONSEIL EUROPÉEN, COE
  // ══════════════════════════════════════════════════════════
  {
    id: "ecb-dora-supervision-2025",
    title: "BCE — Premier cycle de supervision DORA pour les établissements financiers",
    description: "La Banque Centrale Européenne a lancé son premier cycle formel de supervision de la résilience numérique des banques significatives qu'elle supervise directement (MSU). Les banques doivent avoir démontré leur conformité complète à DORA (UE 2022/2554) incluant : tests de résilience TLPT, inventaire des prestataires TIC critiques, plans de continuité numérique et governance du risque technologique. Les IA de gestion de trésorerie et de trading sont explicitement dans le périmètre.",
    date: "2025-06-30",
    isEstimated: true,
    dateLabel: "T2-T3 2025",
    type: "Délai réglementaire",
    importance: "haute",
    regulation: "DORA (UE 2022/2554)",
    authorityId: "ecb",
    tags: ["BCE", "DORA", "Finance", "TLPT", "MSU", "Résilience numérique"],
    sourceUrl: "https://www.ecb.europa.eu/press/pr/rss/ecb.xml",
  },
  {
    id: "eca-ai-audit-2026",
    title: "Cour des comptes EU — Audit de la mise en œuvre de l'AI Act par la Commission",
    description: "La Cour des comptes européenne prévoit un audit de l'efficacité de la mise en œuvre de l'AI Act par la Commission Européenne et l'AI Office, notamment sur la désignation des autorités nationales compétentes (ANC), le fonctionnement des sandboxes réglementaires et la supervision des modèles GPAI à risque systémique. Le rapport est attendu en 2026-2027.",
    date: "2026-12-31",
    isEstimated: true,
    dateLabel: "2026-2027",
    type: "Publication officielle",
    ...
    regulation: "AI Act (UE 2024/1689)",
    authorityId: "eca",
    tags: ["Cour des comptes", "AI Act", "Audit EU", "ANC", "AI Office"],
    sourceUrl: "https://www.eca.europa.eu/fr",
  },
  {
    id: "coe-cets225-ratification-2025",
    title: "Conseil de l'Europe — CETS 225 : ouverture aux ratifications nationales",
    description: "La Convention-cadre CETS 225 sur l'IA, ouverte à la signature le 5 septembre 2024 à Vilnius, entre dans sa phase de ratification par les États signataires (UE, USA, UK, Canada, Japon, Israël…). L'entrée en vigueur est conditionnée à 5 ratifications dont 3 États membres du Conseil de l'Europe. Premier traité international juridiquement contraignant sur l'IA, il obligera les signataires à protéger les droits fondamentaux face aux systèmes IA des acteurs privés.",
    date: "2025-09-05",
    isEstimated: true,
    dateLabel: "2025-2026",
    type: "Entrée en vigueur",
    ...
    authorityId: "coe",
    tags: ["Conseil de l'Europe", "CETS 225", "Traité IA", "Ratification", "International"],
    sourceUrl: "https://www.coe.int/fr/web/artificial-intelligence/the-framework-convention-on-ai",
  },
  {
    id: "iso-42001-certification-2025",
    title: "ISO 42001 — Démarrage des premières certifications en Europe",
    description: "La norme ISO 42001 (AIMS — AI Management System), publiée en décembre 2023 et alignée sur l'AI Act, entre en phase de déploiement des certifications. Les organismes accrédités commencent à délivrer les premières certifications ISO 42001 en Europe. La conformité ISO 42001 peut faciliter la démonstration de conformité à l'AI Act pour les systèmes à haut risque (présomption de conformité via normes harmonisées).",
    date: "2025-10-01",
    isEstimated: true,
    dateLabel: "2025-2026",
    type: "Publication officielle",
    importance: "moyenne",
    regulation: "AI Act (UE 2024/1689)",
    tags: ["ISO 42001", "Certification", "AIMS", "Normes harmonisées", "Conformité AI Act"],
    sourceUrl: "https://www.iso.org/standard/81230.html",
  },
  {
    id: "european-council-ai-summit-2026",
    title: "Conseil européen — Sommet sur la gouvernance internationale de l'IA",
    description: "Les chefs d'État et de gouvernement de l'UE devraient aborder la gouvernance internationale de l'IA lors d'un sommet en 2026, notamment la coordination avec les partenaires G7 sur la régulation des GPAI, l'interopérabilité des cadres réglementaires (AI Act vs CETS 225 vs UK AI Act vs US EO), et la stratégie d'autonomie technologique de l'Europe face aux modèles IA américains et chinois.",
    date: "2026-03-20",
    isEstimated: true,
    dateLabel: "T1 2026",
    type: "Sommet / Conférence",
    ...
    tags: ["Conseil européen", "Sommet IA", "G7", "Gouvernance internationale", "Autonomie numérique"],
    sourceUrl: "https://www.consilium.europa.eu/fr/european-council/",
  },
  {
    id: "ombudsman-ai-report-2026",
    title: "Médiateur européen — Rapport sur la transparence des IA à la Commission",
    description: "Le Médiateur européen devrait publier en 2026 les conclusions de son enquête stratégique sur l'utilisation des systèmes IA par la Commission Européenne dans ses processus décisionnels. Le rapport devrait formuler des recommandations contraignantes sur la transparence algorithmique, le droit d'accès aux documents et les recours effectifs pour les citoyens affectés par des décisions assistées par IA.",
    date: "2026-06-30",
    isEstimated: true,
    dateLabel: "T2-T3 2026",
    type: "Publication officielle",
    importance: "moyenne",
    regulation: "AI Act (UE 2024/1689)",
    authorityId: "ombudsman-eu",
    tags: ["Médiateur EU", "Transparence", "Commission EU", "IA décisions", "Rapport"],
    sourceUrl: "https://www.ombudsman.europa.eu/fr",
  },
  {
    id: "eesc-platform-directive-2026",
    title: "CESE — Avis sur la mise en œuvre de la directive travailleurs de plateforme",
    description: "Le CESE devrait rendre un avis de suivi sur la mise en œuvre de la directive travailleurs de plateforme (UE 2024/2831), notamment l'effectivité des obligations de transparence algorithmique, l'interdiction des décisions automatisées sans supervision humaine en matière disciplinaire, et la présomption de salariat. Les États membres ont jusqu'à fin 2026 pour la transposer.",
    date: "2026-12-02",
    isEstimated: true,
    dateLabel: "Fin 2026",
    type: "Délai réglementaire",
    ...
    authorityId: "eesc",
    tags: ["CESE", "Travailleurs plateforme", "Transposition", "Algorithmes RH"],
