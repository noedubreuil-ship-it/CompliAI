...
const DOCUMENT_ID = "b7bf2e54-5ce6-448e-8da8-c5af7558ee93";
const isDryRun = !process.argv.includes("--prod");

console.log("=".repeat(70));
console.log("  promote-rgpd-considerants-prod.ts — RGPD Considérants → legal_chunks");
console.log("=".repeat(70));
...
void (async () => {
  ...
  console.log("\n📊 Résumé promotion RGPD Considérants :");
  ...
  else console.log("\n✅ Promotion terminée. RGPD considérants actifs dans legal_chunks.");
})();
